...
class CreateFleetVehicleRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'vehicle_number' => 'required|string|max:255|unique:fleet_vehicles,vehicle_number',
            'make' => 'required|string|max:255',
            'model' => 'required|string|max:255',
            'year' => 'required|integer|min:1900|max:' . (date('Y') + 1),
            'vin' => 'nullable|string|max:17|unique:fleet_vehicles,vin',
            'license_plate' => 'required|string|max:255|unique:fleet_vehicles,license_plate',
